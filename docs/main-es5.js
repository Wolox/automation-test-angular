...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.spinnerService.isLoading.subscribe(function (show) { return _this.showLoading = show; });
    };
...
var CouponModalComponent = /** @class */ (function () {
    function CouponModalComponent(modalService, authService, couponsService) {
        this.modalService = modalService;
        this.authService = authService;
        this.couponsService = couponsService;
        this.opened = false;
    }
    CouponModalComponent.prototype.onClick = function (event) {
    ...
    CouponModalComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.modalService.modalStatusChange.subscribe(function (value) {
            if (value) {
                _this.couponCode = Object(src_app_utils_string_random_generator__WEBPACK_IMPORTED_MODULE_3__["generateRandomString"])(15);
                var userlogger = _this.authService.getUser();
                _this.couponsService.registerFreeCoupon(_this.couponCode, userlogger);
            }
            _this.opened = value;
        });
    };
    CouponModalComponent.prototype.close = function () {
        this.modalService.close();
    };
    CouponModalComponent.ctorParameters = function () { return [
...
var DateInputComponent = /** @class */ (function () {
    function DateInputComponent(inj, form) {
        this.inj = inj;
        this.form = form;
    ...
    DateInputComponent.prototype.onDatePickerChange = function (dateInfo) {
            ...
            providers: [
                {
                    ...
                    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(function () { return DateInputComponent_1; }),
                    multi: true
                }
            ],
...
var FileUploadComponent = /** @class */ (function () {
    function FileUploadComponent(inj, host, form) {
        this.inj = inj;
        this.host = host;
        this.form = form;
        this.file = null;
    ...
    FileUploadComponent.prototype.emitFiles = function (files) {
        var _this = this;
        var file = files && files.item(0);
        var reader = new FileReader();
        reader.readAsDataURL(file);
        reader.onload = function (e) {
            _this.previewImg.nativeElement.src = e.target.result;
        };
        this.onChange(file);
        this.file = file;
    };
    ...
    FileUploadComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.resolveIDs();
        this.submit$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.unsubscribe$)).subscribe(function () {
            var controlErrors = _this.formControl.control.errors;
            _this.showError = false;
            if (controlErrors) {
                _this.showError = true;
            }
        });
        this.formControl.control.valueChanges.subscribe(function (value) {
            if (!value) {
                _this.resetFileInput();
            }
        });
    };
    FileUploadComponent.prototype.resolveIDs = function () {
...
var InputComponent = /** @class */ (function () {
    function InputComponent(inj, form, cdr) {
        this.inj = inj;
        this.form = form;
        this.cdr = cdr;
    ...
    InputComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"])(this.submit$, this.focusOut$, this.showErrorsListener$).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.unsubscribe$)).subscribe(function () {
            var controlErrors = _this.formControl.control.errors;
            _this.showError = false;
            if (controlErrors) {
                _this.showError = true;
        ...
        if (this.formControl.control.validator) {
            var validators = this.formControl.control.validator(this.formControl.control);
            this.isRequired = !!validators.required;
        }
        this.cdr.detectChanges();
        this.resolveIDs();
    };
    InputComponent.prototype.resolveIDs = function () {
...
var NavBarComponent = /** @class */ (function () {
    function NavBarComponent(authService, router, modalService, couponsService) {
        this.authService = authService;
        this.router = router;
        this.modalService = modalService;
        this.couponsService = couponsService;
    ...
    NavBarComponent.prototype.openCouponModal = function () {
        this.modalService.open();
    };
    NavBarComponent.prototype.showFreeCouponButton = function () {
...
var OfferModalComponent = /** @class */ (function () {
    function OfferModalComponent() {
        this.opened = false;
    ...
    OfferModalComponent.prototype.open = function (offer) {
        this.offer = offer;
        this.opened = true;
    };
    ...
    OfferModalComponent.prototype.confirmOder = function () {
        this.opened = false;
        this.confirmOrder.next(true);
    };
    OfferModalComponent.prototype.resetOffer = function () {
        this.offer = {
            id: '',
            date: '',
            price: 0,
...
var RadioInputComponent = /** @class */ (function () {
    function RadioInputComponent(inj, form, cdr) {
        this.inj = inj;
        this.form = form;
        this.cdr = cdr;
        this.options = [];
    ...
    RadioInputComponent_1 = RadioInputComponent;
    RadioInputComponent.prototype.ngOnInit = function () {
        this.formControl = this.inj.get(_angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgControl"]);
        this.resolveIDs();
    };
    RadioInputComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    RadioInputComponent.prototype.resolveIDs = function () {
        this.idError = "e-" + this.id;
    };
    ...
    RadioInputComponent.prototype.ngOnDestroy = function () {
        this.unsubscribe$.next();
    };
    ...
    RadioInputComponent = RadioInputComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            providers: [
                {
                    provide: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NG_VALUE_ACCESSOR"],
                    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(function () { return RadioInputComponent_1; }),
                    multi: true
                }
            ],
...
var SelectComponent = /** @class */ (function () {
    function SelectComponent(inj, form, cdr) {
        this.inj = inj;
        this.form = form;
        this.cdr = cdr;
        this.options = [];
    ...
    SelectComponent.prototype.onFocusout = function (event) {
        this.focusOut$.next(event);
    };
    ...
    SelectComponent.prototype.ngAfterViewInit = function () {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"])(this.submit$, this.focusOut$).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.unsubscribe$)).subscribe(function () {
            var controlErrors = _this.formControl.control.errors;
            _this.showError = false;
            if (controlErrors) {
                _this.showError = true;
    ...
    SelectComponent.prototype.resolveIDs = function () {
        this.idError = "e-" + this.id;
    };
...
var CouponsComponent = /** @class */ (function () {
    function CouponsComponent(authService, couponsService) {
        this.authService = authService;
        this.couponsService = couponsService;
        this.coupons = [];
    }
    CouponsComponent.prototype.ngOnInit = function () {
        var userLogged = this.authService.getUser();
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(offersService, loadingService) {
    ...
    HomeComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.offerModal.confirmOrderEvent.subscribe(function (confim) {
            if (confim) {
                _this.loadingService.showLoading(true);
                setTimeout(function () {
                    _this.loadingService.showLoading(false);
                    _this.confirmationModal.open();
                }, 2000);
            }
        });
    };
    HomeComponent.prototype.updateOffers = function (sortBy) {
        var _this = this;
        this.offersService.getOffers(sortBy).subscribe(function (response) {
            _this.offers = response.offers;
            _this.sortedBy = response.pagination.sortBy;
            _this.sortedType = response.pagination.sortType;
        });
    };
    HomeComponent.prototype.resolveSortClass = function (sortBy) {
        return {
    ...
    HomeComponent.prototype.openOfferModal = function (offer) {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(formBuilder, router, localStorage) {
    ...
    LoginComponent.prototype.getErrorMessage = function (control) {
        var controlErrors = this.loginForm.get(control).errors;
        var errorMessage = '';
        if (controlErrors) {
            var errorKey = Object.keys(controlErrors)[0];
            errorMessage = LOGIN_ERRORS[control][errorKey];
        }
        return errorMessage;
    };
    LoginComponent.prototype.validateSubmitDisabled = function () {
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.getErrorMessage = function (control) {
        var controlErrors = this.form.get(control).errors;
        var errorMessage = '';
        if (controlErrors) {
            var errorKey = Object.keys(controlErrors)[0];
...
var CouponsService = /** @class */ (function () {
    function CouponsService(localStorage) {
        this.localStorage = localStorage;
    }
    CouponsService.prototype.registerFreeCoupon = function (coupon, user) {
        var freeCouponKey = this.localStorage.FREE_COUPON;
        var freeCouponList = this.getFreeCouponsList() || [];
        freeCouponList.push({
            username: user,
            code: coupon,
            date: '2019-12-31',
    ...
    CouponsService.prototype.getFreeCouponsList = function () {
        return this.localStorage.getValue(this.localStorage.FREE_COUPON);
    };
    CouponsService.prototype.getUserCoupons = function (user) {
        var freeCouponList = this.getFreeCouponsList() || [];
        var coupons = [];
        freeCouponList.forEach(function (element) {
    ...
    CouponsService.prototype.userHasCoupons = function (username) {
...
var LocalStorageService = /** @class */ (function () {
    ...
    LocalStorageService.prototype.getValue = function (key) {
        var encodedKey = window.btoa("@@AUTH:" + key);
        var encodedValue;
        try {
        ...
        var stringValue = encodedValue && window.atob(encodedValue);
    ...
    LocalStorageService.prototype.setValue = function (key, value) {
        ...
        var encodedValue = window.btoa(stringValue);
        try {
...
var OffersService = /** @class */ (function () {
    ...
    OffersService.prototype.getOffers = function (sortBy) {
        if (sortBy) {
    ...
    OffersService.prototype.sortOffer = function (sortBy) {
    ...
    OffersService.prototype.sortASC = function (sortBy) {
    ...
    OffersService.prototype.sortDESC = function (sortBy) {
        if (sortBy === SORT_BY.DATE) {
            this.offers.sort(function (a, b) {
                if (a[sortBy] !== b[sortBy]) {
                    return new Date(a[sortBy]) > new Date(b[sortBy]) ? -1 : 1;
...
var SpinnerService = /** @class */ (function () {
    ...
    SpinnerService.prototype.showLoading = function (value) {
...
var generateRandomString = function (charNumber) {
    var result = '';
